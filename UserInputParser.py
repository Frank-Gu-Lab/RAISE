...
def process_user_inputs(raise_param_form: Dict[str, str], usr_param_dir: str | None = None) -> None:  #-> Tuple[Dict[str, str], Dict[str, List[float]], int, Dict[str, str | List[float]], Dict[str, str]]:
